...
<notextile><pre><code data-language="JavaScript">$(document).ready(function () {
     $.getJSON('json-vitaliy.php?top=1', function(data) {
        var content  = data["link"]["@attributes"]["href"];
...
Similar code is used "here":http://www.cloudmotion.com/ alongside "zrss":http://www.zazar.net/developers/jquery/zrssfeed/ which provides a free service for proxying and reading remote RSS feeds.